...
public class JDBCShopDAO extends JDBCDAO<Shop, Integer> implements ShopDAO {
	...
	private static final String[] nomiColonne = new String[]{"id", "id_owner", "latitude", "longitude", "address", "id_comune"};
	private static final Class[] constructorParameterTypes = new Class[]{int.class, int.class, double.class, double.class, String.class, int.class};
