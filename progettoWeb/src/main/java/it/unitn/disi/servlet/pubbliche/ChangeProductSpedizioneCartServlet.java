...
public class ChangeProductSpedizioneCartServlet extends MyServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		boolean spedizione = Model.Parameter.getBoolean(request, "spedizione"); //"true" = spedizione, "false" = ritiro in negozio
		...
		try {
			...
			//}
			CartController.changeSpedizione(session, sp, spedizione);
			Model.Messages.setBoolean(request, "spedizioneProdottoCarrelloModificata");
