...
<div>
	<form action="<%=MyPaths.Public.Servlet.Anonymous.registration%>" method="POST">
		...
		<div class="text-center">
			<a href="<%=MyPaths.Public.Jsp.Anonymous.registrationSeller%>">Vai alla registrazione come VENDITORE</a>
		</div>
