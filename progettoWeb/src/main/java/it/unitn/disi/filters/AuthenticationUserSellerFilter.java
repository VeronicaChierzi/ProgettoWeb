...
public class AuthenticationUserSellerFilter implements Filter {
	...
	public AuthenticationUserSellerFilter() {
	}
	...
	private boolean doBeforeProcessing(ServletRequest request, ServletResponse response)
		...
		if (request instanceof HttpServletRequest) {
			...
			if (session == null || user == null || user.getUserSeller()==null) {
				String contextPath = servletContext.getContextPath();
				if (!contextPath.endsWith("/")) {
					contextPath += "/";
				}
				System.err.println("[AuthenticationUserSellerFilter]: Sono neccassari i permessi di UserSeller per accedere a questa pagina");
				redirect((HttpServletResponse)response, MyPaths.Jsp.allHome);
