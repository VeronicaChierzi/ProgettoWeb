...
public class AuthenticationUserAdminFilter implements Filter {
	...
	public AuthenticationUserAdminFilter() {
	}
	...
	private boolean doBeforeProcessing(ServletRequest request, ServletResponse response)
		...
		if (request instanceof HttpServletRequest) {
			...
			if (session == null || user == null || user.getUserAdmin()==null) {
				String contextPath = servletContext.getContextPath();
				if (!contextPath.endsWith("/")) {
					contextPath += "/";
				}
				System.err.println("[AuthenticationUserAdminFilter]: Sono neccassari i permessi di UserAdmin per accedere a questa pagina");
