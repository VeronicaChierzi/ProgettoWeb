...
public class GetSegnalazioneSellerServlet extends MyServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			try {
				Segnalazione s = segnalazioneDAO.getSegnalazioneSeller(idSegnalazione, user.getId());
			...
			System.err.println("Errore utente non loggato o non venditore in GetSegnalazioneSellerServlet: " + e.getMessage());
		}
	}
