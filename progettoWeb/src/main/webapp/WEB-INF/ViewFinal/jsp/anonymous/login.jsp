        ...
        <ul id="paginazione">
            ...
            <li class="container">
                <div class="header-content">
                    <% if (Model.Messages.consumeBoolean(request, "passwordCambiata")) { %>
                    <div class="alert alert-success" role="alert" style="margin-top: 30px"><span class="glyphicon glyphicon-ok-sign"></span> La password &egrave; stata cambiata con successo. Controlla la tua email.</div>
                    <% }%>
